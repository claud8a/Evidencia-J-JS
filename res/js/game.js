...
function won() {
    againRoll = 3;
    document.getElementById("notice").innerHTML = "Ganste el Juego"; // set the notice to won game
    document.getElementById("rollButton").disabled = true; // disable the roll button
    document.getElementById("rollButton").innerHTML = "Ganaste!"; // change the text of the roll button
...
function lost() {
	...
	document.getElementById("notice").innerHTML = "Lo siento, intentalo de nuevo"; // set the notice to lost game
	document.getElementById("rollButton").disabled = true; // disable the roll button
    document.getElementById("rollButton").innerHTML = "Perdiste :("; // change the text of the roll button
    document.getElementById("replay").style.visibility = "visible"; // show the replay button
...
function crap() {
    ...
    if (againRoll === 0) {
        ...
        if (checkWinResult === true) {
            ...
            point = sum;
			document.getElementById("showPoint").innerHTML = "Punto:"; // show the point field
            document.getElementById("hPoint").value = point; // assign the point value
            document.getElementById("notice").innerHTML = "Tienes un punto, sigue lanzando!"; // update the notice
            document.getElementById("rollButton").innerHTML = "Lanza otra vez"; // change the text of the roll button
...
function playAgain(){
	...
	document.getElementById("rollButton").innerHTML = "Lanzar los dados!"; // Change of the text of the main button
	...
	document.getElementById("notice").innerHTML = "Listo? Lanza los dados para jugar!"; // change the notice text
	document.getElementById("rollButton").disabled = false; // disable the roll button
    document.getElementById("rollButton").innerHTML = "Lanzar dados!"; // change the text of the roll button
